...
- Phase 46 local session diff CLI parity is complete on `codex/p46-cli-01-session-diff-read`, and the cross-surface diff contract matrix is the next ready implementation lane
