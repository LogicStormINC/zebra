...
SCENARIOS = {
    ...
    "event-stream-integrity": None,
    "cursor-expiry-recovery": None,
    "login-expiry": None,
    "multi-session-concurrency": None,
    "pre-tool-call-failure": None,
    "post-write-reconciliation": None,
    "pre-completion-recovery": None,
