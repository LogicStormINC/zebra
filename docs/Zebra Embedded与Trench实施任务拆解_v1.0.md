...
- Status: `Done`；Zebra repo；branch `codex/emb-agui-con-01`；implementation commit `5485fc2e`；depends on completed `EMB-HOST-CON-01`。
...
- Acceptance: golden fixtures cover text/tool/state/error/reconnect；mapping is a pure projection；5/5 focused and 132/132 package tests pass；no API/Worker/Trench runtime wiring。
