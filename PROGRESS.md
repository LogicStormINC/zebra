...
- Repository status: `phase 46 ready`
- Current focus:
  - add local CLI session diff inspection parity
  - lock cross-surface session diff output parity
...
- `P46-CLI-01 - Session Diff CLI Read Surface` is ready on `codex/p46-cli-01-session-diff-read`
