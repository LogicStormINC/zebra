...
- Active phase: `Phase 130 - Durable Tool Trace Correlation`
- Repository status: `phase 129 closed; P130-OBS-01 is ready`
- Current focus:
  - `P130-OBS-01` is ready on `codex/p130-obs-01-durable-tool-trace-correlation`, limited to exact core/API/CLI evidence association for parallel same-name calls plus deterministic legacy-event compatibility
