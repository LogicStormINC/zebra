...
- Active phase: `Phase 120 - Durable General And Coding Tool Profiles`
- Repository status: `phase 119 closed; P120-CAP-01 is ready`
- Current focus:
  - `P120-CAP-01` is ready to persist one fixed general or coding tool profile from task launch through worker execution without changing the Policy authority ceiling
