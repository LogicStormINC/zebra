...
- Active phase: `Phase 127 - Bounded Local Skill Progressive Disclosure`
- Repository status: `phase 126 closed; P127-SKILL-01 implementation complete and awaiting review`
- Current focus:
  - `P127-SKILL-01` is complete on `codex/p127-skill-01-local-progressive-disclosure`, with configured Hermes-compatible metadata-first Skill disclosure, bounded support reads, no authority widening, and no fixed Research-child exposure
