...
def test_handoff_runtime_evidence_exposes_every_continuity_field() -> None:
    ...
    capsule = ContextCapsule(
        ...
        completed_actions=("Cloud Worker wired",),
        pending_actions=("Trench acceptance",),
        rejected_approaches=("bypass signed Host authority",),
    ...
    for marker in (
        ...
        "Completed: Cloud Worker wired",
        "Pending: Trench acceptance",
        "Rejected approach: bypass signed Host authority",
        "Permission boundary: production writes require approval",
