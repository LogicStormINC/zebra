...
def test_lease_migration_is_concurrent_repeatable_and_does_not_bootstrap_epoch(
    ...
    assert migrations == [
        ...
        (30, "host_manifest_freezes", 64),
        (31, "client_capabilities", 64),
        (32, "client_sessions", 64),
        (33, "client_effects", 64),
        (34, "client_session_credentials_and_effect_parent", 64),
        (35, "command_pending_and_broker_outbox", 64),
        (36, "command_wakeup_backfill_progress", 64),
        (37, "broker_outbox_expired_publishing_index", 64),
        (38, "command_handoff_receipts_and_inbox", 64),
        (39, "command_execution_event_receipts", 64),
        (40, "command_recovery_generations", 64),
        (41, "command_message_input_receipt", 64),
        (42, "command_control_outcomes", 64),
        (43, "historical_command_retirement", 64),
        (44, "command_pending_pickup_lanes", 64),
        (45, "command_delivery_quarantine", 64),
        (46, "runtime_instances", 64),
        (47, "command_runtime_cleanup_claims", 64),
        (48, "direct_control_cleanup_anchors", 64),
        (49, "command_admission_capacity", 64),
        (50, "command_rollout_shadow", 64),
        (51, "scoped_extension_configuration", 64),
        (52, "skill_package_publications", 64),
        (53, "skill_package_upload_keys", 64),
        (54, "turn_extension_snapshots", 64),
