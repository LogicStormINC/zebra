...
def model_response_event(
    ...
    *,
    ...
    payload: dict[str, object] = {
        ...
        "request_hash": completion.call_metadata.request_hash,
        "message_count": completion.call_metadata.message_count,
        "message_prefix_hashes": list(completion.call_metadata.message_prefix_hashes),
