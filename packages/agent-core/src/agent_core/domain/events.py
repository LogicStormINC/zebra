...
class EventType(StrEnum):
    ...
    SESSION_WAITING_FOR_CLIENT_EFFECT = "session_waiting_for_client_effect"
    CLIENT_EFFECT_SCHEDULED = "client_effect_scheduled"
    CLIENT_EFFECT_RECEIPT_ACCEPTED = "client_effect_receipt_accepted"
