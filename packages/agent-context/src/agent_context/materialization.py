...
def _capsule_content(capsule: ContextCapsule) -> tuple[str, bool]:
    sections: tuple[tuple[str, tuple[str, ...]], ...] = (
        ...
        ("Plan", capsule.plan),
        ("Completed actions", capsule.completed_actions),
        ("Pending actions", capsule.pending_actions),
        ("Rejected approaches", capsule.rejected_approaches),
        ...
        ("Permission boundaries", capsule.permission_boundaries),
