...
import { availableMcpToolNames, projectMcpCapabilities } from "../src/lib/mcp-capabilities.ts";
...
assert.deepEqual(availableMcpToolNames({
  ...
  server_count: 1,
  tool_count: 1,
  servers: [{ name: "docs", tool_count: 1, tools: [{ name: "search", description: "", input_fields: [] }] }],
}), ["mcp.docs.search"]);
