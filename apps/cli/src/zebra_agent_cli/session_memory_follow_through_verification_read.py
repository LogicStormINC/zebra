...
def read_session_memory_overdue_retention_breach_follow_through_verification_states(
    *,
    ...
    highest_state = _highest_priority_overdue_retention_breach_follow_through_verification_scope(
        scopes
    )
    return {
        "session_id": session_id,
        ...
        "highest_priority_overdue_retention_breach_follow_through_verification_priority": (
            None
            if highest_state is None
            else highest_state["overdue_retention_breach_follow_through_verification_priority"]
        ),
        ...
        "highest_priority_overdue_retention_breach_follow_through_verification_reasons": (
            []
            if highest_state is None
            else highest_state["overdue_retention_breach_follow_through_verification_reasons"]
        ),
        "scopes": scopes,
    }
...
def read_session_memory_overdue_retention_breach_follow_through_verification_outcomes(
    *,
    ...
    highest_outcome = (
        _highest_priority_overdue_retention_breach_follow_through_verification_outcome_scope(scopes)
    )
    return {
        "session_id": session_id,
        "database": str(database_path),
        ...
        "highest_priority_overdue_retention_breach_follow_through_verification_outcome": (
            ...
            else highest_outcome["overdue_retention_breach_follow_through_verification_outcome"]
        ),
