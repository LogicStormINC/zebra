...
export function useDataTable<TData>(props: UseDataTableProps<TData>) {
  ...
  // oxlint-disable-next-line react/incompatible-library -- TanStack Table's useReactTable is incompatible with React Compiler memoization by design; the compiler already skips optimizing this hook
